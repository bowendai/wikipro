...
function auth_logoff($keepbc = false) {
    ...
    setcookie(DOKU_COOKIE, '', time() - 600000, $cookieDir, '', ($conf['securecookie'] && dokuwiki_is_ssl()), true);
...
function auth_setCookie($user, $pass, $sticky) {
    ...
    setcookie(DOKU_COOKIE, $cookie, $time, $cookieDir, '', ($conf['securecookie'] && dokuwiki_is_ssl()), true);
